...
int main()
{
	...
	initManagerAndAirline(&manager, &compress ,&company, airlineFileName);
	...
	chooseSaveMethod(compress, &company, airlineFileName);
...
int initManagerAndAirline(AirportManager* pManager, int* compress, Airline* pCompany,const char* ailineFileName)
{
